...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        try:
            ...
            # Add "Available" to the transaction combo box
            self.ui.transactioncbox.addItem("Available")
            ...
            self.ui.transactionstable.cellDoubleClicked.connect(self.show_transaction_info_dialog)
    ...
    def show_transaction_info_dialog(self, row, column):
        transaction_data = []  # Data for the selected transaction
        for col_idx in range(self.ui.transactionstable.columnCount()):
            item = self.ui.transactionstable.item(row, col_idx)
            if item:
