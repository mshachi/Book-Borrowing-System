...
class ReserveBookDialog(object):
    def __init__(self):
        self.dialog = None
    ...
    def setupUi(self, ReserveDialog):
        ...
        self.customercbox.setStyleSheet(" background: black")
    ...
    def ConfirmReserve(self):
        ...
        reserve_date = self.selected_reserve_date
        reserve_fee = self.rentfeefield.text()

        if reserve_date is None:
            print("Reservation date is not selected")
            QtWidgets.QMessageBox.warning(self.dialog, "Error", "Reservation date is not selected")
            return
        ...
        try:
            ...
            if book_id_result is None:
                ...
                QtWidgets.QMessageBox.warning(self.dialog, "Error", "Book not found")
                conn.close()
                return
            ...
            if customer_id_result is None:
                ...
                QtWidgets.QMessageBox.warning(self.dialog, "Error", "Customer not found")
                conn.close()
                return
