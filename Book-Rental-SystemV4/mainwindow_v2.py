...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.transactionstable.setHorizontalHeaderLabels(["Date", "Action", "Book Title", "Customer Name"])
        ...
        # After setting up the transactioncbox items
        transaction = ["All", "Rentals", "Returns", "Reservations"]
        self.transactioncbox.addItems(transaction)

        # Set default index to "All"
        default_index = self.transactioncbox.findText("All")
        if default_index >= 0:
            self.transactioncbox.setCurrentIndex(default_index)
        ...
        self.booksearch.setPlaceholderText("Enter Book Title, Author, Category, Status, or Rental Fee")
        self.booksearch.setGeometry(QtCore.QRect(10, 1, 870, 31))
        ...
        self.customersearch.setPlaceholderText("Enter Customer Name, Gender, or ID Number")
        self.customersearch.setGeometry(QtCore.QRect(10, 1, 870, 31))
