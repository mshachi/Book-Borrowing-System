...
class addCustomerDialog(object):
    ...
    def generate_customer_id(self):
        try:
            ...
            QMessageBox.critical(None, "Error", f"Error generating customer ID: {e}")
            return None

    def confirm_add_customer(self):
        print("Adding customer...")
        # Get the values from the input fields
        ...
        # Regular expression pattern to match digits and symbols but no alphabet characters
        pattern = r'^[0-9()\-/]+$'

        # Use re.match to check if the phone number matches the pattern
        if re.match(pattern, phone_number):
            # Prepare the data to be inserted into the database
            customer_info = (customerId, name, gender, phone_number, valid_id_path)
            ...
            try:
                ...
                with sqlite3.connect("library.db") as conn:
                    ...
                    # Show a message box to inform the user about the successful operation
                    QMessageBox.information(self.dialog, "Success", "Customer added successfully!")
            except sqlite3.Error as e:
                # Display an error message if an error occurs
                QMessageBox.critical(self.dialog, "Error", f"Error adding customer: {e}")
                print(f"Error adding customer: {e}")
        else:
            # Display a message box indicating incorrect phone number format
            QMessageBox.critical(self.dialog, "Error", "Please enter a valid phone number.")
