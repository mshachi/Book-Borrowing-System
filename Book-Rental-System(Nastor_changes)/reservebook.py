...
"            }")
        ...
        self.reservedate.clicked.connect(self.select_reservation_date)
    ...
    def select_reservation_date(self):
        ...
        try:
                ...
                calendar.selectionChanged.connect(lambda: self.on_reservation_date_selected(calendar))
    ...
    def on_reservation_date_selected(self, calendar):
        ...
        # Set the selected date as the text of the reservedate button
